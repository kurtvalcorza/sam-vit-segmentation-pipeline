    ...
    "cells": [
        ...
        },
        {
            "md": (
                ...
                "within a few hundredths of the numbers below from one GPU run to the next."
            ),
            "code": (
        ...
        },
        {
            "md": (
                ...
                "seat — gain the most. The cell asserts the adapted point IoU is above the frozen one and reports "
